...
namespace sim{
   ...
   uint64_t output_rate_counter=0;
	...
	double spin_lifetime = 466e-12; // spin lifetime in chiral magnetic field ** added 
	double phonon_lifetime = 0.65e-12; // Phonon lifetime in chiral magnetic field ** added
